      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg font-medium text-sm shadow-sm transition-colors w-full sm:w-auto"
          >
        ...
        >
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-9 sm:pl-10 pr-4 py-2 sm:py-2.5 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-sm"
            />
          </div>
        ...
        >
          ...
          <div className="px-4 sm:px-6 py-10 sm:py-16 text-center">
            <div className="mx-auto w-12 sm:w-16 h-12 sm:h-16 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center mb-3 sm:mb-4">
              <UsersIcon className="w-6 sm:w-8 h-6 sm:h-8 text-blue-600 dark:text-blue-400" />
            </div>
            ...
            <motion.button
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-3 sm:px-4 py-2 rounded-lg font-medium text-sm transition-colors"
            >
