...
export default function FeedbackDemoPage() {
  ...
  const variants: Array<'neutral' | 'primary' | 'success' | 'warning' | 'danger'> = [
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="mx-auto max-w-6xl px-4">
        ...
        <section className="mb-12">
          ...
          {/* Con iconos */}
          <div className="mb-8">
            <h3 className="text-lg font-medium text-gray-700 mb-4">Con iconos</h3>
            <div className="flex flex-wrap gap-3">
              <StatusBadge
                label="Success"
                variant="success"
        ...
        <section className="mb-12">
          ...
          {/* Con icono */}
          <div className="mb-2">
            <h3 className="text-lg font-medium text-gray-700 mb-4">Con icono</h3>
            <div className="flex flex-wrap gap-3">
        ...
        <section className="mb-12">
          ...
          <div className="mb-8">
            ...
            {removablePills.length === 0 && (
              <p className="text-gray-500 italic">Todas las pills han sido eliminadas</p>
            )}
          </div>
        </section>
