    ...
    >
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">Tus clientes más valiosos</p>
        </div>
        <motion.button
          whileHover={{ scale: 1.05, x: 2 }}
          whileTap={{ scale: 0.95 }}
          className="flex items-center space-x-1 text-sm text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 font-medium"
        >
          <span>Ver todos</span>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between mb-1">
                <h4 className="text-sm font-semibold text-gray-900 dark:text-white group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors truncate">
                  {client.name}
                </h4>
      ...
      >
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-gray-600 dark:text-gray-400">Clientes activos</p>
          </div>
        </div>
      </motion.div>
    </motion.div>
