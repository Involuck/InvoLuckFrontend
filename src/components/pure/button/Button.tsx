...
export default function Button({
  ...
  const baseClasses =
    'font-bold rounded transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed';
  ...
  const variantClasses = {
    ...
    secondary:
      'bg-brand-700 hover:bg-brand-800 text-white focus:ring-brand-600',
    success:
